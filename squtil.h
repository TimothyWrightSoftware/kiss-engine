...
static void print_stack_value( HSQUIRRELVM v, SQObjectType type, SQInteger index ) {
	switch( type ) {
		case OT_NULL: std::cout << "[" << index << "] " << "NULL"; break;
		...
		case OT_TABLE: std::cout << "[" << index << "] " << "TABLE"; break;
		case OT_ARRAY: std::cout << "[" << index << "] " << "ARRAY"; break;
		case OT_USERDATA: std::cout << "[" << index << "] " << "USERDATA"; break;
		case OT_CLOSURE: std::cout << "[" << index << "] " << "CLOSURE"; break;
		case OT_NATIVECLOSURE: std::cout << "[" << index << "] " << "NATIVECLOSURE"; break;
		case OT_GENERATOR: std::cout << "[" << index << "] " << "GENERATOR"; break;
		case OT_USERPOINTER: std::cout << "[" << index << "] " << "USERPOINTER"; break;
		case OT_BOOL: print_bool( v, index ); break;
		case OT_INSTANCE: std::cout << "[" << index << "] " << "INSTANCE"; break;
		case OT_CLASS: std::cout << "[" << index << "] " << "CLASS"; break;
		case OT_WEAKREF: std::cout << "[" << index << "] " << "WEAKREF"; break;
		default: std::cout << "[" << index << "] " << "UNKNOWN"; break;
	}
